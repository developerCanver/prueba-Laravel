        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header p-3 mb-2 bg-success text-white">
                    <h5 style="color:#fff" class="modal-title text-while" id="exampleModalLabel">Agregar Modelo:</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="POST" action="{{ route('modelos.create') }}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Nombre Modelo">
                        ...
                        <ol class="breadcrumb float-sm-right">
                            <h2>
                                <button type="button" class="btn btn-success float-right" data-toggle="modal"
                                    data-target="#exampleModal" data-whatever="@mdo">Agregar Modelos</button>
                            </h2>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="card-footer">
                                    ...
                                    <form action="{{route('modelos.destroy', $consulta->id)}}"
                        ...
                        <div class="modal fade" id="editUser{{$consulta->id}}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('modelos.update', $consulta->id)}}" method="POST">
                                        @csrf
                                        @method('PUT')
